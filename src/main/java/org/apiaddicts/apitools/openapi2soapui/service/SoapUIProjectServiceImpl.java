...
public class SoapUIProjectServiceImpl implements SoapUIProjectService {
	...
	public SoapUIProject createSoapUIProject(String apiName, OpenAPI openAPI, List<OAuth2Profile> credentials, List<Header> headers,
			Set<String> testCaseNames, Boolean readOnly, String serverPattern, Boolean minimalEndpoints, Boolean microcksHeaders, Boolean generateOneOfAnyOf) throws IOException, XmlException, SoapUIException {
		return new SoapUIProject(apiName, openAPI, credentials, headers, testCaseNames, readOnly, serverPattern, minimalEndpoints, microcksHeaders, generateOneOfAnyOf);
	}
