...
public interface SoapUIProjectService {
    SoapUIProject createSoapUIProject(String apiName, OpenAPI openAPI, List<OAuth2Profile> oAuth2Profiles, List<Header> headers, Set<String> testCases, SoapUIProjectOptions options) throws IOException, XmlException, SoapUIException;
}
