...
public interface SoapUIProjectService {
    SoapUIProject createSoapUIProject(String apiName, OpenAPI openAPI, List<OAuth2Profile> oAuth2Profiles, List<Header> headers, Set<String> testCases, Boolean readOnly, String serverPattern, Boolean minimalEndpoints, Boolean microcksHeaders) throws IOException, XmlException, SoapUIException;
}
